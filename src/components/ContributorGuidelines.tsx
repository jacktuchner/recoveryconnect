...
const GUIDELINES_KEY = "recovery-connect-contributor-guidelines-accepted";

interface ContributorGuidelinesProps {
  children: React.ReactNode;
  onAccept?: () => void;
}

export default function ContributorGuidelines({ children, onAccept }: ContributorGuidelinesProps) {
    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full p-6 my-8">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Contributor Guidelines</h2>
